...
aRegion(0)
{
    ...
    /*
    sizeOfVoxelAlongX = 0.2 *mm;
    sizeOfVoxelAlongY = 0.2*mm; //100 *mm;
    sizeOfVoxelAlongZ = 0.2*mm; //100 *mm;
    */

    /* for testing B field spot position relation
    sizeOfVoxelAlongX = 0.5*mm;
    sizeOfVoxelAlongY = 0.5*mm; //100 *mm;
    sizeOfVoxelAlongZ = 0.5*mm; //100 *mm;
    */

    //sizeOfVoxelAlongX = 0.1*mm;
    //sizeOfVoxelAlongY = 30 * cm; //100 *mm;
    //sizeOfVoxelAlongZ = 30 * cm; //100 *mm;

    sizeOfVoxelAlongX = 1.5*mm;
    sizeOfVoxelAlongY = 1.5*mm; //100 *mm;
    sizeOfVoxelAlongZ = 1.5*mm; //100 *mm;
    ...
    //SetDetectorSize(2.*cm, 2.*cm, 2.*cm);
    SetDetectorSize(30.*cm, 30.*cm, 30.*cm);
