...
/////////////////////////////////////////////////////////////////////////////
ProtontherapyEventActionMessenger::ProtontherapyEventActionMessenger(ProtontherapyEventAction* EvAct)
:eventAction(EvAct)
{
...
/////////////////////////////////////////////////////////////////////////////
ProtontherapyEventActionMessenger::~ProtontherapyEventActionMessenger()
{
  delete DrawCmd;
  delete PrintCmd;
  delete eventDir;         
...
/////////////////////////////////////////////////////////////////////////////
void ProtontherapyEventActionMessenger::SetNewValue(G4UIcommand* command,
                                          G4String newValue)
{ 
  if(command == DrawCmd)
