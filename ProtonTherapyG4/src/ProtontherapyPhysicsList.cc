...
ProtontherapyPhysicsList::ProtontherapyPhysicsList() : G4VModularPhysicsList()
{
    ...
    pMessenger = new ProtontherapyPhysicsListMessenger(this);
...
/////////////////////////////////////////////////////////////////////////////
ProtontherapyPhysicsList::~ProtontherapyPhysicsList()
{
    delete pMessenger;
...
/////////////////////////////////////////////////////////////////////////////
void ProtontherapyPhysicsList::ConstructProcess()
{
    // Transportation
    //
    AddTransportation();
...
/////////////////////////////////////////////////////////////////////////////
void ProtontherapyPhysicsList::AddPhysicsList(const G4String& name)
{
    if (verboseLevel>1) {
...
/////////////////////////////////////////////////////////////////////////////
void ProtontherapyPhysicsList::AddStepMax()
{
  // Step limitation seen as a process
  // This process must exist in all threads.
  //
  ProtontherapyStepMax* stepMaxProcess  = new ProtontherapyStepMax();
...
/////////////////////////////////////////////////////////////////////////////
void ProtontherapyPhysicsList::SetCuts()
{
